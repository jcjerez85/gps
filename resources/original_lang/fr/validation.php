...
return array(
    ...
    'attributes'  => array(
        ...
        'count' => 'Compter',
        'detect_distance' => 'Détection de distance par',
        'detect_speed' => 'Détection de vitesse par',
        'routes' => 'Itinéraires',
        'battery_threshold' => 'Seuil de batterie',
        'state' => 'État',
        'duration' => 'Durée',
        'statuses' => 'Statuts',
        'first_name' => 'Prénom',
        ...
        'default_duration_format' => 'Format de durée par défaut',
        'login_token' => 'Jeton',
        'monthly' => 'Mensuel',
        'amount' => 'Montant',
        'bad_sms_gateway_url' => 'Mauvaise URL ou configuration de la passerelle SMS',
        'rates' => 'Les taux',
        'fields' => 'Des champs',
        'tenant_id' => 'ID locataire',
        'client_secret' => 'Secret client',
        'default_login_methods' => 'Méthodes de connexion par défaut',
        'forwards' => 'Attaquants',
        'detection_speed' => 'Vitesse de détection',
        'detach_on_no_position_data' => 'Détacher sans données de position',
        'extra_expiration_time' => 'Délai d&#39;expiration supplémentaire',
        'fuel_detect_sec_after_stop' => 'Détecter le changement de carburant après l&#39;arrêt',
    ...
    'uploaded' => 'L :attribute n&#39;a pas pu être téléchargé. Il est possible que le serveur n&#39;accepte pas une telle taille.',
    'login_methods'  => array(
        'email' => 'E-mail',
        'azure' => 'Microsoft Azure',
    ),
    'host' => 'L&#39; :attribute n&#39;est pas un hôte valide',
    'host_port' => 'Le :attribute ne correspond pas au format HOST :PORT',
    'unique_table_msg' => 'Le :attribute a déjà été pris dans :table',
);