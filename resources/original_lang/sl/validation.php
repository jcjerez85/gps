...
return array(
    ...
    'attributes'  => array(
        ...
        'merchant_code' => 'Koda trgovca',
        'count' => 'štetje',
        'detect_distance' => 'Zaznavanje razdalje z',
        'detect_speed' => 'Zaznavanje hitrosti s',
        'routes' => 'Poti',
        'battery_threshold' => 'Prag baterije',
        'state' => 'Država',
        'duration' => 'Trajanje',
        'statuses' => 'Statusi',
        'first_name' => 'Ime',
        'last_name' => 'Priimek',
        'personal_code' => 'Osebna koda',
        'birth_date' => 'Rojstni datum',
        'company_id' => 'Podjetje',
        'registration_code' => 'Registracijska koda',
        'vat_number' => 'Davčna številka',
        'address' => 'Naslov',
        'comment' => 'Komentiraj',
        'duration_format' => 'Oblika trajanja',
        'default_duration_format' => 'Privzeta oblika trajanja',
        'login_token' => 'Žeton',
        'monthly' => 'Mesečno',
        'amount' => 'Znesek',
        'bad_sms_gateway_url' => 'Napačen URL ali konfiguracija prehoda SMS',
        'rates' => 'Stopnje',
        'fields' => 'Polja',
        'tenant_id' => 'ID najemnika',
        'client_secret' => 'Skrivnost stranke',
        'default_login_methods' => 'Privzeti načini prijave',
        'forwards' => 'Naprej',
        'detection_speed' => 'Hitrost zaznavanja',
        'detach_on_no_position_data' => 'Odklopite brez podatkov o položaju',
        'extra_expiration_time' => 'Dodaten čas poteka',
        'fuel_detect_sec_after_stop' => 'Zaznavanje menjave goriva po zaustavitvi',
    ...
    'uploaded' => ':attribute ni bilo mogoče naložiti. Možno je, da strežnik ne sprejme takšne velikosti.',
    'login_methods'  => array(
        'email' => 'E-naslov',
        'azure' => 'Microsoft Azure',
    ),
    'host' => ':attribute ni veljaven gostitelj',
    'host_port' => ':attribute se ne ujema s formatom HOST :PORT',
    'unique_table_msg' => ':attribute je bil že prevzet v :table',
);