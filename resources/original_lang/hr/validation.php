...
return array(
    ...
    'attributes'  => array(
        ...
        'merchant_code' => 'Šifra trgovca',
        'count' => 'Računati',
        'detect_distance' => 'Detekcija udaljenosti pomoću',
        'detect_speed' => 'Detekcija brzine pomoću',
        'routes' => 'Rute',
        ...
        'first_name' => 'Ime',
        'last_name' => 'Prezime',
        'personal_code' => 'Osobni kod',
        'birth_date' => 'Datum rođenja',
        'company_id' => 'Društvo',
        'registration_code' => 'Registracijski kod',
        'vat_number' => 'PDV broj',
        'address' => 'Adresa',
        'comment' => 'Komentar',
        'duration_format' => 'Format trajanja',
        'default_duration_format' => 'Zadani format trajanja',
        'login_token' => 'Znak',
        'monthly' => 'Mjesečno',
        'amount' => 'Iznos',
        'bad_sms_gateway_url' => 'Loš URL ili konfiguracija pristupnika za SMS',
        'rates' => 'Cijene',
        'fields' => 'Polja',
        'tenant_id' => 'ID stanara',
        'client_secret' => 'Tajna klijenta',
        'default_login_methods' => 'Zadani načini prijave',
        'forwards' => 'Naprijed',
        'detection_speed' => 'Brzina detekcije',
        'detach_on_no_position_data' => 'Odvojite bez podataka o položaju',
        'extra_expiration_time' => 'Dodatno vrijeme isteka',
        'fuel_detect_sec_after_stop' => 'Otkrijte promjenu goriva nakon zaustavljanja',
    ...
    'uploaded' => 'Prijenos :attribute nije uspio. Moguće je da poslužitelj ne prihvaća takvu veličinu.',
    'login_methods'  => array(
        'email' => 'E-mail',
        'azure' => 'Microsoft Azure',
    ),
    'host' => ':attribute nije važeći host',
    'host_port' => ':attribute ne odgovara formatu HOST :PORT',
    'unique_table_msg' => ':attribute je već zauzet u :table',
);