...
return array(
    ...
    'attributes'  => array(
        ...
        'position' => 'позиция',
        'stop_duration_longer_than' => 'Продължителността на престоя е по дълга от',
        ...
        'merchant_code' => 'Код на търговеца',
        'count' => 'Броя',
        'detect_distance' => 'Откриване на разстояние чрез',
        'detect_speed' => 'Откриване на скорост от',
        'routes' => 'Маршрути',
        'battery_threshold' => 'Праг на батерията',
        'state' => 'състояние',
        'duration' => 'Продължителност',
        'statuses' => 'Статуси',
        'first_name' => 'Първо име',
        'last_name' => 'Фамилия',
        'personal_code' => 'Персонален код',
        'birth_date' => 'Рождена дата',
        'company_id' => 'Търговско дружество',
        'registration_code' => 'Регистрационен код',
        'vat_number' => 'ДДС номер',
        'address' => 'Адрес',
        'comment' => 'Коментирайте',
        'duration_format' => 'Формат на продължителността',
        'default_duration_format' => 'Формат на продължителността по подразбиране',
        'login_token' => 'Токен',
        'monthly' => 'Месечно',
        'amount' => 'Количество',
        'bad_sms_gateway_url' => 'Лош URL адрес или конфигурация на SMS шлюз',
        'rates' => 'Цени',
        'fields' => 'Полета',
        'tenant_id' => 'ID на наемател',
        'client_secret' => 'Тайна на клиента',
        'default_login_methods' => 'Методи за влизане по подразбиране',
        'forwards' => 'Напред',
        'detection_speed' => 'Скорост на откриване',
        'detach_on_no_position_data' => 'Отделяне при липса на данни за позиция',
        'extra_expiration_time' => 'Допълнително време на изтичане',
        'fuel_detect_sec_after_stop' => 'Откриване на смяна на гориво след спиране',
    ...
    'uploaded' => 'Качването на :attribute не бе успешно. Възможно е сървърът да не приема такъв размер.',
    'login_methods'  => array(
        'email' => 'електронна поща',
        'azure' => 'Microsoft Azure',
    ),
    'host' => ':attribute не е валиден хост',
    'host_port' => ':attribute не съответства на формата HOST :PORT',
    'unique_table_msg' => ':attribute вече е взет в :table',
);