...
return array(
    ...
    'attributes'  => array(
        ...
        'count' => 'Počítať',
        'detect_distance' => 'Detekcia vzdialenosti podľa',
        'detect_speed' => 'Detekcia rýchlosti podľa',
        'routes' => 'Trasy',
        'battery_threshold' => 'Prah batérie',
        'state' => 'Štát',
        'duration' => 'Trvanie',
        'statuses' => 'Stavy',
        'first_name' => 'Krstné meno',
        'last_name' => 'Priezvisko',
        'personal_code' => 'Osobný kód',
        'birth_date' => 'Dátum narodenia',
        'company_id' => 'Spoločnosť',
        'registration_code' => 'Registračný kód',
        'vat_number' => 'Identifikačné číslo DPH',
        'address' => 'Adresa',
        'comment' => 'Komentujte',
        'duration_format' => 'Formát trvania',
        'default_duration_format' => 'Predvolený formát trvania',
        'login_token' => 'Token',
        'monthly' => 'Mesačne',
        'amount' => 'Suma',
        'bad_sms_gateway_url' => 'Nesprávna adresa URL alebo konfigurácia brány SMS',
        'rates' => 'Sadzby',
        'fields' => 'Polia',
        'tenant_id' => 'ID nájomcu',
        'client_secret' => 'Tajomstvo klienta',
        'default_login_methods' => 'Predvolené spôsoby prihlásenia',
        'forwards' => 'Útočníci',
        'detection_speed' => 'Rýchlosť detekcie',
        'detach_on_no_position_data' => 'Odpojenie bez údajov o polohe',
        'extra_expiration_time' => 'Extra doba platnosti',
        'fuel_detect_sec_after_stop' => 'Zistiť výmenu paliva po zastavení',
    ...
    'uploaded' => 'Nepodarilo sa odovzdať :attribute . Je možné, že server takúto veľkosť neakceptuje.',
    'login_methods'  => array(
        'email' => 'Email',
        'azure' => 'Microsoft Azure',
    ),
    'host' => ':attribute nie je platným hostiteľom',
    'host_port' => ':attribute sa nezhoduje s formátom HOST :PORT',
    'unique_table_msg' => ':attribute už bol v :table prevzatý',
);