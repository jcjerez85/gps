...
return array(
    ...
    'attributes'  => array(
        ...
        'count' => 'Liczyć',
        'detect_distance' => 'Wykrywanie odległości przez',
        'detect_speed' => 'Wykrywanie prędkości przez',
        'routes' => 'Trasy',
        'battery_threshold' => 'Próg baterii',
        'state' => 'Państwo',
        'duration' => 'Czas trwania',
        'statuses' => 'Statusy',
        'first_name' => 'Imię',
        'last_name' => 'Nazwisko',
        'personal_code' => 'Osobisty kod',
        ...
        'comment' => 'Komentarz',
        'duration_format' => 'Format czasu trwania',
        'default_duration_format' => 'Domyślny format czasu trwania',
        'login_token' => 'Znak',
        'monthly' => 'Miesięczny',
        'amount' => 'Kwota',
        'bad_sms_gateway_url' => 'Nieprawidłowy adres URL lub konfiguracja bramki SMS',
        'rates' => 'Stawki',
        'fields' => 'Pola',
        'tenant_id' => 'Identyfikator najemcy',
        'client_secret' => 'Sekret klienta',
        'default_login_methods' => 'Domyślne metody logowania',
        'forwards' => 'Naprzód',
        'detection_speed' => 'Szybkość wykrywania',
        'detach_on_no_position_data' => 'Odłącz bez danych o pozycji',
        'extra_expiration_time' => 'Dodatkowy czas wygaśnięcia',
        'fuel_detect_sec_after_stop' => 'Wykryj zmianę paliwa po zatrzymaniu',
    ...
    'uploaded' => 'Nie udało się przesłać :attribute . Możliwe, że serwer nie akceptuje takiego rozmiaru.',
    'login_methods'  => array(
        'email' => 'E-mail',
        'azure' => 'Microsoft Azure',
    ),
    'host' => ':attribute nie jest prawidłowym hostem',
    'host_port' => ':attribute nie pasuje do formatu HOST :PORT',
    'unique_table_msg' => 'Opcja :attribute została już wykorzystana w :table',
);