...
return array(
    ...
    'attributes'  => array(
        ...
        'count' => 'Numara',
        'detect_distance' => 'Detectarea distantei prin',
        'detect_speed' => 'Detectarea vitezei prin',
        'routes' => 'Trasee',
        'battery_threshold' => 'Pragul bateriei',
        'state' => 'Stat',
        'duration' => 'Durată',
        'statuses' => 'Statuturi',
        'first_name' => 'Nume',
        'last_name' => 'Numele de familie',
        'personal_code' => 'Cod personal',
        'birth_date' => 'Data nasterii',
        'company_id' => 'Companie',
        'registration_code' => 'Cod de înregistrare',
        'vat_number' => 'TVA',
        'address' => 'Abordare',
        'comment' => 'Cometariu',
        'duration_format' => 'Formatul duratei',
        'default_duration_format' => 'Format de durată implicit',
        'login_token' => 'Jeton',
        'monthly' => 'Lunar',
        'amount' => 'Cantitate',
        'bad_sms_gateway_url' => 'URL sau configurație greșită a gateway-ului SMS',
        'rates' => 'Tarife',
        'fields' => 'Câmpuri',
        'tenant_id' => 'ID locatar',
        'client_secret' => 'Secretul clientului',
        'default_login_methods' => 'Metode de conectare implicite',
        'forwards' => 'Înainte',
        'detection_speed' => 'Viteza de detectare',
        'detach_on_no_position_data' => 'Detașați fără date de poziție',
        'extra_expiration_time' => 'Timp de expirare suplimentar',
        'fuel_detect_sec_after_stop' => 'Detectează schimbarea combustibilului după oprire',
    ...
    'uploaded' => ':attribute nu a putut fi încărcat. Este posibil ca serverul să nu accepte o astfel de dimensiune.',
    'login_methods'  => array(
        'email' => 'E-mail',
        'azure' => 'Microsoft Azure',
    ),
    'host' => ':attribute nu este gazdă validă',
    'host_port' => ':attribute nu se potrivește cu formatul HOST :PORT',
    'unique_table_msg' => ':attribute a fost deja preluat în :table',
);