@forelse ($groups as $group)
    <div class="group" data-toggle="multiCheckbox">
        <div class="group-heading">
            ...
            <div class="group-title {{ $group['open'] ? '' : 'collapsed' }}" data-toggle="collapse" data-target="#route-group-{{ $group['id'] }}" data-parent="#objects_tab" aria-expanded="{{ $group['open'] ? 'true' : 'false' }}" aria-controls="route-group-{{ $group['id'] }}">
